...
def serviceName = "jobber-auth"
def service = "Jobber Auth"
...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "kevin1208" + "/" + "jobber-auth"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        // Add your auth service url to url field
        git branch: 'master', credentialsId: 'github', url: 'https://github.com/kevindeveloper95/jobapp-auth'
        script {
